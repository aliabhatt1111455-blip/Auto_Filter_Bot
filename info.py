...
BOT_TOKEN = environ.get('BOT_TOKEN', "6627105339:AAE1MSox9n0FWhqch7o_G2YgcfnLaDH-faU")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://graph.org/file/260c48ae415a72664da09-c5bd54a881f5bf5ef5.jpg https://graph.org/file/51f5c8367cf4712f5de6a-d6808cebd04ee20e2c.jpg')).split()  # Sample pic
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003661537142').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003530324599'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003264416822'))  # Bin channel id (make sure bot is admin)
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS","-1003575424766")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://aliabhatta144_db_user:Adarsh12345@cluster0.ng9wbyb.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
